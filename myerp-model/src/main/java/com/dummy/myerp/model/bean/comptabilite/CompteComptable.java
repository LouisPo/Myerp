...
public class CompteComptable {
     ...
     */
    // FIXME Delete this comment: Answer this:Why static ? Found see
    // ComptabiliteManagerImpl
    // isCompteComptableExist
    /*
     * this method doesn't use any attribute class and id not in accoradance with
     * static definition. Moreover, this class seem to be use in a dynamic way.
     * untill answered @supress warning added to method using this.
     */
