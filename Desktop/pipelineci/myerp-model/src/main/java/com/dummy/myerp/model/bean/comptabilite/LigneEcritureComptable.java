...
public class LigneEcritureComptable {
	...
	public LigneEcritureComptable(CompteComptable pCompteComptable, String pLibelle, BigDecimal pDebit,
		...
		libelle = pLibelle;
		debit = fixedScale(parseIfNullToBigdecimal(pDebit));
		credit = fixedScale(parseIfNullToBigdecimal(pCredit));
	}
	...
	private BigDecimal parseIfNullToBigdecimal(BigDecimal vBigDecimal) {
		BigDecimal vRetour = vBigDecimal == null ? BigDecimal.ZERO : vBigDecimal;
		return vRetour;
	}
	 ...
	 * @param pBigDecimal
	 * @param pScale
	 * @return A BigDecimal with at least 2 fractional digits
	 */
