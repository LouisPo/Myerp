...
public interface ComptabiliteDao {
	...
	// FIXME added by FLE suppress this comment



	/**
	 *
	 * @param pJournalCode the JournalCode
	 * @param pAnnee the year
	 * @return the SequenceEcritureComptable with key pJournal AND pAnnee
	...
	/**
	 *
	 * @param pSequenceEcritureComptable the SequenceEcritureComptable to insert
	 */
