...
public class EcritureComptableTest {
    ...
    public void isEquilibree() {
        ...
        //methode utilisee par RG_Compta_1 afficchage montant crediteur ou debiteur
        System.out.println(vEcriture.natureSolde());
    }
    
    /** methode utilisee par RG_Compta_1
    Le solde d'un compte comptable est égal à la somme des montants au débit des lignes d'écriture
    diminuées de la somme des montants au crédit. Si le résultat est positif, le solde est dit "débiteur", 
    si le résultat est négatif le solde est dit "créditeur".
    */
    public String natureSolde() {
    	BigDecimal solde;
    	BigDecimal sommeDebits;
    	BigDecimal sommeCredits;
    	String etatsolde="";
    	
    	sommeDebits =vEcriture.getTotalDebit();
    	sommeCredits = vEcriture.getTotalCredit();
    	solde = sommeDebits.subtract(sommeCredits);
