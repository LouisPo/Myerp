...
public interface ComptabiliteManager {
	 ...
	 * @throws NotFoundException   if SequenceComptableNotFound note: this exception
	 *                             is expected
	 * @throws FunctionalException if Reference cretaed not respect RG_Compta_0
	 */
	 ...
	 *                             règles de gestion
	 * @throws NotFoundException   if JournalComptable or CompteComptable not found
	 */
	 ...
	 * @throws FunctionalException Si l'Ecriture comptable ne respecte pas les
	 *                             règles de gestion
	 * @throws NotFoundException   If JournalComptable or CompteComptable set are
	 *                             not found
	 */
	...
	/**
	 *
	 * @param pJournalCode the jounalCode
	 * @param pAnnee the year
	 * @return The SequenceEcritureComptable having for pair pJournalCode AND pAnnee
	 * @throws NotFoundException if SequenceComptable not found
	 */
